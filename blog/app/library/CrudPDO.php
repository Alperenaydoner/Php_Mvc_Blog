...
class CrudPDO
{
    ...
    {
        $kayde = $this->db->prepare("INSERT into proje set sifre=:sifre,eposta=:mail");
    ...
    {
        $kayde = $this->db->prepare("INSERT into icerik set konu=:sifre,metin=:mail");
    ...
    public function towread($table,  $options = [])
    {


        try {

            $stmt = $this->db->prepare("SELECT * FROM $table WHERE  sifre=:sifre 
            && eposta=:mail ");
            $stmt->execute(array(
